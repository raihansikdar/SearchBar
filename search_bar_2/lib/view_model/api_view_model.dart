  ...
  void onInit() {
    ...
    void fetchData() async {
      ...
      if (response.statusCode == 200) {
        ...
        final jsonListData = jsonResponse
            .map((apiData) => SearchModel.fromJson(apiData))
            .toList();

        _dataList.value = jsonListData;
        ...
        change(null,
            status: RxStatus.error('errorCode: ${response.statusCode}'));
      }
    }
